...
| 1.4.2 智能代理的实现  | 1.4.2 エージェントの実装 | 19 |
...
| 2.1.2 智能代理与环境的互动  | 2.1.2 エージェントと環境のやりとり  | 39 |
| 2.2 环境和智能代理的数学表示  | 2.2 環境とエージェントの定式化  | 40 |
| 2.2.1 状态迁移  | 2.2.1 状態遷移  | 40 |
| 2.2.2 奖励函数  | 2.2.2 報酬関数  | 42 |
| 2.2.3 智能代理的策略  | 2.2.3 エージェントの方策 | 43 |
...
| 5.3.2 智能代理类的实现  | 5.3.2 エージェントクラスの実装  | 132  |
...
| 8.1.2 随机智能代理  | 8.1.2 ランダムなエージェント | 216  |
